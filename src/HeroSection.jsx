...
const HeroSection = ({ trending }) => {
  ...
  return (
    <div
      className={`transition-all duration-700 bg-no-repeat px-10 py-10 relative`}
      style={style}
    >
      <div className="flex flex-col h-full relative">
        ...
        <p className="text-3xl px-3 rounded text-gray-100 hover:text-[#979090] transition-all duration-300   absolute top-56">
          Millions of movies, TV shows and people to discover. Explore now.
        </p>
        <div className="p-1 bg-gradient-to-r font-bold from-gray-500 to-pink-100 shadow   rounded-r-2xl  relative top-72">
          <Search />
        </div>
      </div>
    </div>
